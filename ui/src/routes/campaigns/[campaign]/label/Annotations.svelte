...
<section class="flex flex-col overflow-hidden flex-1 h-full">
  ...
  {:else}
    <div class="overflow-auto flex-grow">
      <table class="w-full table">
        <thead>
          <tr>
            <th class="text-left sticky top-0 bg-bg2">Label</th>
            <th class="text-left sticky top-0 bg-bg2">Type</th>
